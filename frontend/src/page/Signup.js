    ...
    <div className='p-3 md:p-4'>
      <div className='flex items-center justify-center bg-white m-auto max-w-sm p-5 flex-col'>
        ...
        <form className='w-full py-3 m-2' onSubmit={handleSubmit}>
            ...
            <input type={"text"} id='firstName' name='firstName' className='mt-1 mb-2 w-full bg-slate-200 p-1 px-2 py-1 rounded focus-within:outline-blue-500' value={data.firstName} onChange={handleOnChange}/>

            <label htmlFor='lastName'>Last Name</label>
            <input type={"text"} id='lastName' name='lastName' className='mt-1 mb-2 w-full bg-slate-200 p-1 px-2 py-1 rounded focus-within:outline-blue-500' value={data.lastName} onChange={handleOnChange} />
            ...
            <button className='max-w-[120] w-full bg-blue-500 hover:bg-blue-600 cursor-pointer m-auto text-white text-xl font-medium text-center py-1 rounded-full mt-5'>Sign Up</button>

            <p className='mt-2 text-base'>Already a User! <Link to={'/login'} className='text-blue-600 underline'>Login</Link></p>
        </form>
