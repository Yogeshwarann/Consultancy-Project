    ...
    <div className='w-full min-w-[200px] max-w-[200px] bg-white hover:shadow-lg drop-shadow-lg px-4 pt-5 cursor-pointer flex flex-col'>
        {
            ...
            <h3 className='font-bold text-slate-600 capitalize text-lg mt-4'>{name}</h3>
            ...
            <button className='font-bold text-slate-900 capitalize text-lg mt-5 bg-blue-500 py-1 my-3 rounded hover:bg-blue-600 w-full' onClick={handleAddCart}>Add Cart</button>            
            </>
